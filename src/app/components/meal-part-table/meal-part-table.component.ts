...
@Component({
  selector: 'app-meal-part-table',
  templateUrl: './meal-part-table.component.html',
  styles: [
  ]
})
export class MealPartTableComponent implements OnInit {

  @Input() parts: MealPart[];
  totals: Food;

  //  Table
  dataSource: MatTableDataSource<MealPart> = new MatTableDataSource();
